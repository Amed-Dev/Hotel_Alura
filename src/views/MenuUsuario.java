...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		labelExit.setFont(new Font("Nunito", Font.PLAIN, 18));
	    ...
	    JLabel lblNewLabel_3 = new JLabel("🗄️ Registro de Reservas y Huéspedes");
	    ...
	    JLabel lblNewLabel_3_2 = new JLabel("🗑️ Eliminar todo tipo de registros");
